...
final class RoleDischargeHandler implements HandlerInterface
{
    ...
    public function run(RunnerInterface $runner): int|Response
    {
        ...
        try {
            $this->roles->removeRole($user, $role);
        ...
        $runner->io()->writeln("Роль {$role} снята с пользователя {$user}.", 'success');
