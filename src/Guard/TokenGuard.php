...
use PhpSoftBox\Auth\Provider\RequestAwareTokenProviderInterface;
...
final class TokenGuard implements GuardInterface
{
    ...
    public function user(ServerRequestInterface $request): mixed
    {
        ...
        if ($this->tokens instanceof RequestAwareTokenProviderInterface) {
            return $this->tokens->retrieveUserByTokenForRequest($token, $request);
        }
