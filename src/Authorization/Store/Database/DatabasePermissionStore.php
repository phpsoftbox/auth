...
final class DatabasePermissionStore implements PermissionStoreInterface, TransactionalStoreInterface
{
    ...
    public function transaction(callable $callback): mixed
    {
        ...
        return $conn->transaction(static fn (mixed $_conn = null): mixed => $callback());
    }
}
