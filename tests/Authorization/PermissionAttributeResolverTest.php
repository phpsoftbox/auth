...
final class PermissionAttributeResolverTest extends TestCase
{
    ...
    /**
     * Проверяет, что RequiresPermission принимает BackedEnum.
     */
    #[Test]
    public function resolvesBackedEnumMethodAttribute(): void
    {
        $resolver = new PermissionAttributeResolver();

        $requirement = $resolver->resolve([AttributeController::class, 'enumUpdate']);
