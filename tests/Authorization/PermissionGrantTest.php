...
final class PermissionGrantTest extends TestCase
{
    ...
    /**
     * Проверяет нормализацию BackedEnum в строковое имя ресурса.
     */
    #[Test]
    public function normalizesBackedEnumResource(): void
    {
        $grant = new PermissionGrant(TestPermissionEnum::UsersRead);

        self::assertSame('users.base.read', $grant->resource);
    }
}
