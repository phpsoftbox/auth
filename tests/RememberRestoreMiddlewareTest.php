...
final class RememberRestoreMiddlewareTest extends TestCase
{
    ...
    private function users(): ArrayUserProvider
    {
        return new ArrayUserProvider([
            ['id' => 10, 'email' => 'first@example.test', 'password_hash' => password_hash('secret', PASSWORD_DEFAULT)],
            ['id' => 20, 'email' => 'second@example.test', 'password_hash' => password_hash('secret', PASSWORD_DEFAULT)],
        ]);
    }
